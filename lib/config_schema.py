...
_FIELDS: list[dict] = [
    ...
    {"key": "generate_engine", "section": "imagegen", "type": "select",
     "options": _opt(("cloudflare", "Cloudflare Workers AI — free, fast (needs account + token)"),
                     ("vertex", "Vertex AI — Google image models, pooled (needs project)"))},
    ...
    {"key": "generate_retries", "section": "imagegen", "type": "number",
     ...
     "show_if": {"generate": ["mixed", "all"]}},
    # Vertex pool settings (model × region rotation)
    {"key": "vertex_models", "section": "imagegen", "type": "textarea",
     "show_if": {"generate_engine": ["vertex"]}},
    ...
    {"key": "cf_model", "section": "imagegen", "type": "select", "allow_custom": True,
     "options": _opt(("@cf/black-forest-labs/flux-2-klein-4b",
                      "FLUX.2 klein 4B — best FREE quality, ~60 imgs/day/account (recommended)"),
                     ("@cf/black-forest-labs/flux-2-klein-9b",
                      "FLUX.2 klein 9B — higher quality, uses more free credit (~7/day/account)"),
