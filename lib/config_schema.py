...
_FIELDS: list[dict] = [
    ...
    {"key": "generate_smart_prompt", "section": "imagegen", "type": "select",
     "options": _opt(("auto", "auto — LLM writes a detailed, consistent prompt"),
                     ("off", "off — plain prompt from the search phrase")),
    ...
    {"key": "generate_retries", "section": "imagegen", "type": "number",
     ...
     "show_if": {"generate": ["mixed", "all"]}},
    # Vertex pool settings (model × region rotation) — the only image engine
