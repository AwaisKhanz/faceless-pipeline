...
_FIELDS: list[dict] = [
    ...
    {"key": "cf_model", "section": "imagegen", "type": "select", "allow_custom": True,
     "options": _opt(("@cf/bytedance/stable-diffusion-xl-lightning",
                      "SDXL-Lightning — best quality, free, 16:9 (recommended)"),
                     ("@cf/stabilityai/stable-diffusion-xl-base-1.0",
                      "Stable Diffusion XL base"),
                     ("@cf/black-forest-labs/flux-1-schnell",
                      "FLUX.1 schnell — fastest, square/lower detail")),
     "show_if": {"generate_engine": ["cloudflare"]}},
    {"key": "cf_steps", "section": "imagegen", "type": "number",
     "int": True, "min": 1, "max": 20, "step": 1,
     "show_if": {"generate_engine": ["cloudflare"]}},
